...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-2 bg-card", className)}
      classNames={{
        ...
        button_previous: cn(
          ...
          "h-6 w-6 bg-transparent p-0 opacity-50 hover:opacity-100 border-border text-foreground"
        ),
        button_next: cn(
          buttonVariants({ variant: "outline" }),
          "h-6 w-6 bg-transparent p-0 opacity-50 hover:opacity-100 border-border text-foreground"
        ...
        day_button: cn(
          ...
          "h-7 w-7 p-0 font-normal aria-selected:opacity-100 text-foreground hover:bg-primary/20 hover:text-foreground text-[11px]"
        ),
